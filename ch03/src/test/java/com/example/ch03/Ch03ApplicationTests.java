...
class Ch03ApplicationTests {
  ...
  @Test
  void givenDatasourceAvailableWhenAccessDetailsThenExpectDetails()
          throws SQLException {
  ...
  @Test
  void givenUserRepositoryThenSaveUser() {
  ...
  @Test
  void givenUpdateUserThenFindById() {
    User user = new User("미나미 아이자와", "1234", 20);
  ...
  @Test
  void givenDeleteUserThenFindById() {
    User user = new User("미나미 아이자와", "1234", 20);
    userRepository.save(user);
